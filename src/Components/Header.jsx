      ...
      <nav className="bg-white border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
            <img src={dollarLogo} alt="Dollar Files Logo" className="w-40" />
          </a>
          ...
          <div className="hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
          ...
          <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse gap-2 mt-[13px] ml-[22px] md:mt-0 md:ml-0">
            ...
            >
              ...
              <ul className="py-2" aria-labelledby="user-menu-button">
                ...
                <li>
                  <a
                    href="#"
                    className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-red-500 dark:hover:text-red-700"
                  >
                    Sign out
                  </a>
                </li>
